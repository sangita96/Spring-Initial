...
%>
	...
	User Registration Completed for <span style=" color: red;"> <%= _uname.toUpperCase() %> </span>
	with Email Id <span style=" color:maroon; "> <%= _email  %> </span><br />
...
%>
	<div>
					...
					<br/>
					<br/>
	<h2>Email Id <span style="color: maroon;"> <%= _email %> </span> Already Registered Try Another </h2> 
	</div>
