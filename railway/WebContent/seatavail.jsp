...
%>		
	...
	<tr align="left">
    	<td bgcolor=#333333 style="color:white; font-weight:bold;"> <label > Date Of Travel </label> </td>
       	<td> <input type="text" name="date" readnly="readonly" id="datepicker" title="YYYY/MM/DD" style="background-color: white;" /> </td>
    </tr>
</table>
<p>
...
//			System.out.println(rs.getString("train_no"));
	...
	//			System.out.println(rs.getString(week_travel));
		...
		while(rs.next()){
			...
			out.println("<td>  <input type='text' value="+rs.getString("train_name")+"  /> </td>");
			out.println("<td>  <input type='text' size='10' value="+rs.getString("type")+"  /> </td>");
			out.println("<td>  <input type='text' name='date1' size='10' value="+rs.getDate("dep_date")+"  /> </td>");
			out.println("<td>  <input type='text' size='15' value="+rs.getString("s_station_name")+"  /> </td>");
			out.println("<td>  <input type='text' size='15' value="+rs.getString("d_station_name")+" /> </td>");
			out.println("</tr>");
